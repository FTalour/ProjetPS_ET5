...
public class PhaOptions extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        spinnerScenar.setModel(new javax.swing.SpinnerNumberModel(5000, 1, 10000, 1));
        ...
        sliderScenar.setMajorTickSpacing(2500);
        sliderScenar.setMaximum(10000);
        sliderScenar.setMinimum(1);
        sliderScenar.setMinorTickSpacing(100);
        ...
        if(OKpressed){
            ...
            switch(comboBoxSolveurs.getItemAt(comboBoxSolveurs.getSelectedIndex())){
                case "recuit":
                    second = new Recuit();
                    break;
                    //On ne peut pas utiliesr le pha comme solveur secondaire, il ne renvoie pas le bon type de données.
                /*case "pha":
                    PhaOptions optPha = new PhaOptions((Frame) this.getParent());
                    System.out.println("than");
                    optPha.setVisible(true);
                    Pha pha = optPha.getPha();
                    if(pha != null){
                        System.out.println("than than");
                        second = pha;
                    }
                    break;*/
                default:
